                ...
                <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="" name="judul_produk">
                      <small style="color: red;"><?php echo form_error('judul_produk'); ?></small>
                    </div>

                    <div class="form-group">
                      <label>Keterangan Produk</label>
                      <textarea class="form-control" placeholder="" name="ket_produk"></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control phone-number" placeholder="" name="harga_produk">
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="number" class="form-control phone-number" placeholder=" " name="nilai_voucher">
                      </div>
